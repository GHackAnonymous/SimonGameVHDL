...
set rc [catch {
  ...
  set_property ip_repo_paths d:/vivadoWS/LFSR/LFSR.cache/ip [current_project]
  set_property ip_output_repo d:/vivadoWS/LFSR/LFSR.cache/ip [current_project]
  add_files -quiet D:/vivadoWS/LFSR/LFSR.runs/synth_1/Main.dcp
